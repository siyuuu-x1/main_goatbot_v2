...
module.exports = {
  ...
  onChat: async function ({ event, api }) {
    ...
    const defaults = [
      ...
      ["mone", "🤔"], ["valo laglo", "😍"], ["kothai", "📍"], ["siyam", "🥰"],
      ["siyam", "🥺"], ["tomar jonno", "💗"], ["nila", "😚"], ["dhonnobad", "🙏"],
      ...
      ["chup", "😤"], ["jibon", "🌍"], ["bondhu", "👬"], ["poribar", "👨‍👩‍👧‍👦"],
      ["kaj", "💼"], ["pora", "📚"], ["masti", "😜"], ["ghumay", "😴"], ["kotha bolo", "💬"],
      ["haso", "😂"], ["bhoy", "😱"], ["dosti", "🤝"], ["shopno", "💭"], ["sundor ghum", "😴"],
      ["premer", "💌"], ["moner", "💖"], ["shukh", "😊"], ["mone rakhbe", "📝"],
      ["tarikh", "📅"], ["jaiga", "🌴"], ["pahar", "⛰️"], ["nodi", "🌊"],
      ["ful", "🌸"], ["shopno dekho", "💤"], ["din valo", "☀️"], ["rat", "🌙"],
      ["khela", "⚽"], ["gan", "🎵"], ["nach", "💃"], ["majhe", "😌"],
      ["ekdom valo", "💯"], ["sathe", "🤝"], [" nai", "❌"]
    ];
